                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button id="sample_editable_1_new" onclick="showAjaxModal('<?= base_url(); ?>modal/popup/add_author/');" class="btn sbold green"> <?= get_phrase('add_new'); ?>
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        ...
                                        <?php foreach ($author_info as $row) { ?>
                                            <tr class="odd gradeX">
                                                ...
                                                <td>
                                                    <img src="<?= $this->core_model->get_image_url('author' , $row['author_id']);?>" class="img-circle" width="40px" height="40px">
                                                    <?= $row['name'] ?>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu pull-left" role="menu">
                                                            <li>
                                                                <a href="javascript:;" onclick="showAjaxModal('<?= base_url(); ?>modal/popup/edit_author/<?= $row['author_id'] ?>');">
                                                                    <i class="icon-docs"></i> <?= get_phrase('edit'); ?> </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?= base_url(); ?>admin/authors/change_status/<?= $row['author_id'] ?>">
                                                                    <i class="icon-tag"></i> <?= get_phrase('change_status'); ?> </a>
                                                            </li>
                                                            <li>
                                                                <a href="javascript:;" class="deletebtn" data-type="author" data-id="<?= $row['author_id'] ?>">
