                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        ...
                                        <tbody>
                                        <?php foreach ($freelancer_info as $row) { ?>
                                            <tr class="odd gradeX">
                                                <td>
                                                    <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu pull-left" role="menu">
                                                            <li>
                                                                <a href="javascript:;" onclick="showAjaxModal('<?= base_url(); ?>modal/popup/edit_freelancer/<?= $row['freelancer_id'] ?>');">
                                                                    <i class="icon-docs"></i> <?= get_phrase('edit'); ?> </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?= base_url(); ?>admin/freelancers/change_status/<?= $row['freelancer_id'] ?>">
                                                                    <i class="icon-tag"></i> <?= get_phrase('change_status'); ?> </a>
                                                            </li>
                                                            <li>
                                                                <a href="javascript:;" class="deletebtn" data-type="freelancer" data-id="<?= $row['freelancer_id'] ?>">
