...
class Email_model extends CI_Model {
	...
	public function account_opening_email($account_type = '', $email = '')
	{
	...
	public function password_reset_email($account_type = '', $email = '')
	{
	...
	public function do_email($msg = NULL, $sub = NULL, $to = NULL, $from = NULL)
	{
		$config = array();
        ...
        $msg = $msg . "<br /><br /><br /><br /><br /><br /><br /><hr /><center><a href=\"https://rebidlancer.com\">&copy; 2017 RebidLancer</a></center>";
