                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        ...
                                        <tbody>
                                        <?php foreach ($deleted_author_info as $row) { ?>
                                            <tr class="odd gradeX">
                                                <td>
                                                    <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu pull-left" role="menu">
                                                            <li>
                                                                <a href="javascript:;" class="restorebtn" data-type="deleted_author" data-id="<?= $row['author_id'] ?>">
                                                                    <i class="icon-docs"></i> <?= get_phrase('restore'); ?> </a>
                                                            </li>
                                                            <li>
                                                                <a href="javascript:;" class="deletebtn" data-type="deleted_author" data-id="<?= $row['author_id'] ?>">
