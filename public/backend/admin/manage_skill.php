                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button id="sample_editable_1_new" onclick="showAjaxModal('<?= base_url(); ?>modal/popup/add_skill/');" class="btn sbold green"> <?= get_phrase('add_new'); ?>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu pull-left" role="menu">
                                                            <li>
                                                                <a href="javascript:;" onclick="showAjaxModal('<?= base_url(); ?>modal/popup/edit_skill/<?= $row['skill_id'] ?>');">
                                                                    <i class="icon-docs"></i> <?= get_phrase('edit'); ?> </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?= base_url(); ?>admin/skills/change_status/<?= $row['skill_id'] ?>">
                                                                    <i class="icon-tag"></i> <?= get_phrase('change_status'); ?> </a>
                                                            </li>
                                                            <li>
                                                                <a href="javascript:;" class="deletebtn" data-type="skill" data-id="<?= $row['skill_id'] ?>">
