                            ...
                            <li class="m-menu__item  m-menu__item--submenu <?php if ($page_name == 'manage_author' || $page_name == 'add_author' || $page_name == 'edit_author') echo 'm-menu__item--open m-menu__item--expanded'?>" aria-haspopup="true"  data-menu-submenu-toggle="hover">
                                ...
                                <div class="m-menu__submenu">
                                    ...
                                    <ul class="m-menu__subnav">
                                        <li class="m-menu__item <?php if ($page_name == 'manage_author') echo 'm-menu__item--active'?>" aria-haspopup="true" >
                            ...
                            <li class="m-menu__item  m-menu__item--submenu <?php if ($page_name == 'manage_category' || $page_name == 'add_category' || $page_name == 'edit_category' || $page_name == 'manage_subcategory' || $page_name == 'add_subcategory' || $page_name == 'edit_subcategory' || $page_name == 'change_position_category') echo 'm-menu__item--open m-menu__item--expanded'?>" aria-haspopup="true"  data-menu-submenu-toggle="hover">
                                ...
                                <div class="m-menu__submenu">
                                    ...
                                    <ul class="m-menu__subnav">
                                        ...
                                        <li class="m-menu__item  m-menu__item--submenu <?php if ($page_name == 'manage_category' || $page_name == 'add_category' || $page_name == 'edit_category') echo 'm-menu__item--open m-menu__item--expanded'?>" aria-haspopup="true"  data-menu-submenu-toggle="hover">
                                            <a  href="#" class="m-menu__link m-menu__toggle">
                                                <i class="m-menu__link-bullet m-menu__link-bullet--dot">
                                                    <span></span>
                                                </i>
                                                ...
                                                <ul class="m-menu__subnav">
                                                    ...
                                                    <li class="m-menu__item <?php if ($page_name == 'add_subcategory') echo 'm-menu__item--active'?>" aria-haspopup="true" >
                                                        <a href="<?=base_url()?>admin/subcategories/add" class="m-menu__link ">
                                                            ...
                                                            <span class="m-menu__link-text">
                                                                <?= get_phrase('add_new_subcategory'); ?>
                                                            </span>
                                                        </a>
                                                    </li>
                                                </ul>
