<?php
	$single_subcategory_info = $this->db->get_where('subcategory', array('subcategory_id' => $this->uri->segment(4)))->result_array();
						...
						<div class="row">
							<div class="col-lg-12">
								...
								<div class="m-portlet">
									...
									<!--begin::Form-->
									<form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" action="<?=base_url()?>admin/subcategories/update/<?=$row['subcategory_id']?>" method="post" enctype="multipart/form-data">
										<div class="m-portlet__body">
											<div class="form-group m-form__group row">
												<div class="col-lg-6">
													...
													<input type="text" name="name" id="name" class="form-control m-input" placeholder="<?=get_phrase('enter_name')?>" value="<?=$row['name']?>" required>
												...
												<div class="col-lg-6">
													...
													<div class="m-input-icon m-input-icon--right">
														<textarea name="description" id="description" class="form-control m-input" placeholder="<?=get_phrase('enter_description')?>" rows="5" required><?=$row['description']?></textarea>
											...
											<div class="form-group m-form__group row">
												...
												?>
														<option value="<?=$row2['category_id']?>" <?php if ($row['category_id'] == $row2['category_id']) echo 'selected'; ?>>
															<?= $row2['name'] ?>
														</option>
												<?php } ?>
													</select>
