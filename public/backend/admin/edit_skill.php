<?php
	$single_skill_info = $this->db->get_where('skill', array('skill_id' => $this->uri->segment(4)))->result_array();
						...
						<div class="row">
							<div class="col-lg-12">
								...
								<div class="m-portlet">
									...
									<!--begin::Form-->
									<form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" action="<?=base_url()?>admin/skills/update/<?=$row['skill_id']?>" method="post" enctype="multipart/form-data">
