<?php
	$single_freelancer_info = $this->db->get_where('freelancer', array('freelancer_id' => $this->uri->segment(4)))->result_array();
	foreach ($single_freelancer_info as $row) {
?>
						...
						<div class="row">
							<div class="col-lg-12">
								...
								<div class="m-portlet">
									...
									<!--begin::Form-->
									<form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" action="<?=base_url()?>admin/freelancers/update/<?= $row['freelancer_id'] ?>" method="post" enctype="multipart/form-data">
										<div class="m-portlet__body">
											...
											<div class="form-group m-form__group row">
												<div class="col-lg-6">
													...
													<div></div>
													<img src="<?=$this->core_model->get_image_url('freelancer' , $row['freelancer_id'])?>" class="m--img-rounded m--marginless" alt="" width="40" height="40">
